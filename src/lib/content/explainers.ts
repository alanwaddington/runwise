...
export const EXPLAINERS: Record<string, PageExplainerContent> = {
	...
	'/race-predictor': {
		...
		intro:
			'This tool predicts a finish time for one distance based on a real result at another, using Pete Riegel’s widely used endurance-running formula: T₂ = T₁ × (D₂ / D₁)^1.06.',
		sections: [
			{
	...
	'/training-paces': {
		...
		intro:
			'This calculator uses Jack Daniels’ VDOT method to turn a recent race result into a set of training paces matched to your current fitness, rather than generic paces based on age or experience level.',
		sections: [
			{
	...
	'/parkrun': {
		...
		intro:
			'This tool predicts your parkrun (5K) time from a recent training run or average pace, then compares it against your personal best and shows an age-graded performance rating.',
		sections: [
			{
