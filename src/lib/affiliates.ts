...
export const AFFILIATE_LINKS: Record<string, AffiliateProduct[]> = {
	'/pace': [
		{
			...
			url: 'https://www.amazon.co.uk/dp/B0CWM8R8QZ?tag=runwise-21',
			program: 'amazon',
			tag: 'runwise-21'
		},
		{
			...
			url: 'https://www.amazon.co.uk/dp/B0BW8SMPWJ?tag=runwise-21',
			program: 'amazon',
			tag: 'runwise-21'
		}
	],
	'/race-predictor': [
		...
		},
		{
			...
			url: 'https://www.amazon.co.uk/dp/B0BW8PBNFM?tag=runwise-21',
			program: 'amazon',
			tag: 'runwise-21'
		}
	],
	'/training-paces': [
		...
		},
		{
			...
			url: 'https://www.amazon.co.uk/dp/B0B3FH6JYX?tag=runwise-21',
			program: 'amazon',
			tag: 'runwise-21'
		}
	],
	...
	'/vo2max': [
		...
		},
		{
			...
			url: 'https://www.amazon.co.uk/dp/B09W6XCKR7?tag=runwise-21',
			program: 'amazon',
			tag: 'runwise-21'
		}
	],
	'/parkrun': [
		...
		},
		{
			...
			url: 'https://www.amazon.co.uk/dp/B093BNXJH8?tag=runwise-21',
			program: 'amazon',
			tag: 'runwise-21'
		}
	]
